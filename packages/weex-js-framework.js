(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK 0.29.6, Build 2019-06-25 15:20. (Vue: 2.5.16-weex.5, Rax: 0.4.20)');
  ...
  return children.map(function (vnode) {
    ...
    if (!type) {
      ...
      if (type === 'span' && isSimpleSpan(vnode)) {
        ...
        props.attr.value = vnode.children[0].text;
        return props
      }
    }
