(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK 0.29.0, Build 2019-03-05 12:49. (Vue: 2.5.13-weex.5, Rax: 0.4.20)');
...
Document.prototype.fireEvent = function fireEvent (el, type, event, domChanges, options) {
  ...
  if ($root && $root.attr) {
    var isBubble = $root.attr['bubble'] === 'true';
