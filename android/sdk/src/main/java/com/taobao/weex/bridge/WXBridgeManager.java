...
public class WXBridgeManager implements Callback, BactchExecutor {
    ...
    private static final String METHOD_DESTROY_INSTANCE = "destroyInstance";
    private static final String METHOD_SET_TIMEOUT = "setTimeoutCallback";
    ...
    private static final String METHD_FIRE_EVENT_SYNC = "fireEventSync";
    private static final String METHOD_REFRESH_INSTANCE = "refreshInstance";
    private static final String METHOD_NOTIFY_SERIALIZE_CODE_CACHE =
            "notifySerializeCodeCache";
    private static final String METHOD_CREATE_INSTANCE_CONTEXT = "createInstanceContext";
    // args
    private static final String COMPONENT = "component";
    private static final String REF = "ref";
    private static final String MODULE = "module";
    private static final String KEY_PARAMS = "params";
    private static final String INITLOGFILE = "/jsserver_start.log";
    ...
    public static boolean BRIDGE_LOG_SWITCH_FS = false;
    static volatile WXBridgeManager mBridgeManager;
    private static long sInitFrameWorkTimeOrigin;
    private static StringBuilder sInitFrameWorkMsg = new StringBuilder();
     ...
     **/
    Handler mJSHandler;
    private byte[] mInterceptorLocker = new byte[0];
    /**
...
//      }
    ...
    private boolean jsEngineMultiThreadEnable() {
     ...
     */
    synchronized void setStackTopInstance(final String instanceId) {
        post(new Runnable() {
    ...
    private Object callModuleMethod(String instanceId, String moduleStr, String methodStr, JSONArray args, JSONObject options) {
    ...
    Object callNativeModule(String instanceId, String module, String method, JSONArray arguments, JSONObject options) {
    ...
    Object callNativeComponent(String instanceId, String componentRef, String method, JSONArray arguments, Object options) {
    ...
    // callUpdateFinish
    int callUpdateFinish(String instanceId, String callback) {
        ...
        try {
            if (BRIDGE_LOG_SWITCH_FS || WXEnvironment.isApkDebugable() && BRIDGE_LOG_SWITCH) {
                ...
                WXLogUtils.i(mLodBuilder.substring(0));
                mLodBuilder.setLength(0);
            }
        } catch (Exception e) {
    ...
    // callRefreshFinish
    int callRefreshFinish(String instanceId, String callback) {
    ...
    private void callReportCrash(String crashFile, final String instanceId, final String url) {
    ...
    private void commitJscCrashAlarmMonitor(final String type, final WXErrorCode errorCode, String errMsg,
    ...
    private boolean shouReloadCurrentInstance(String aUrl) {
    ...
    @NonNull
    private static String argsToJSON(WXJSObject[] args) {
    ...
    private void callbackJavascriptOnDataRender(final String instanceId, final String callback, final Object data, final boolean keepAlive) {
    ...
    public void fireEvent(final String instanceId, final String ref,
        ...
        fireEvent(instanceId, ref, type, data, null);
    }
    ...
    private void invokeCreateInstance(@NonNull WXSDKInstance instance, Script template,
        ...
        if (mMock) {
            ...
            try {
                ...
                try {
                    if (BRIDGE_LOG_SWITCH_FS || WXEnvironment.isApkDebugable() && BRIDGE_LOG_SWITCH) {
                        WXLogUtils.i("createInstance >>>> instanceId:" + instance.getInstanceId()
                                + ", options:"
    ...
    private WXJSObject optionObjConvert(boolean useSandBox, BundType type, WXJSObject opt) {
     ...
     * @return
     */
    private BundType getBundleType(String url, String temp) {
        try {
            if (url != null) {
    ...
    private void invokeDestoryInstance(String instanceId, String namespace, String function,
                                       WXJSObject[] args, boolean logTaskDetail) {
        // if (WXEnvironment.isApkDebugable()) {
        mLodBuilder.append("callJS >>>> instanceId:").append(instanceId)
                .append("function:").append(function);
    ...
    private int invokeCreateInstanceContext(String instanceId, String namespace, String function,
                                            WXJSObject[] args, boolean logTaskDetail) {
        ...
        if (WXSDKEngine.isSoInitialized() && !isJSFrameworkInit()) {
            ...
            try {
                ...
                if (WXEnvironment.sDebugMode) {
                    ...
                    initrst = mWXBridge.initFrameworkEnv(framework, assembleDefaultOptions(), crashFile, pieSupport);
                }
...
//          WXEnvironment.JsFrameworkInit = true;
    ...
    void execJSService(final String service) {
        post(new Runnable() {
            @Override
            public void run() {
     ...
     */
    void reportJSException(String instanceId, String function,
                           String exception) {
    ...
    int callCreateBody(String pageId, String componentType, String ref,
    ...
    int callUpdateStyle(String instanceId, String ref, HashMap<String, Object> styles,
...
//      BRIDGE_LOG_SWITCH_FS ||
    ...
    int callUpdateAttrs(String instanceId, String ref, HashMap<String, String> attrs) {
    ...
    int callLayout(String pageId, String ref, int top, int bottom, int left, int right, int height, int width, boolean isRTL, int index) {
