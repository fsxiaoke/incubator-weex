...
import com.taobao.weex.ui.view.refresh.wrapper.NoBounceRecyclerView;
...
public class WXNbListComponent extends BasicListComponent<NoBounceRecyclerView> {
  ...
  public static class Creator implements ComponentCreator {
    public WXComponent createInstance(WXSDKInstance instance,
      ...
      return new WXNbListComponent(instance, parent, true, basicComponentData);
    }
  }

  @Deprecated
  public WXNbListComponent(WXSDKInstance instance, WXVContainer parent, String instanceId, boolean isLazy, BasicComponentData basicComponentData) {
    this(instance, parent, isLazy, basicComponentData);
  }


  public WXNbListComponent(WXSDKInstance instance, WXVContainer parent, boolean lazy, BasicComponentData basicComponentData) {
    super(instance, parent, basicComponentData);
  }

  @Override
  protected NoBounceRecyclerView generateListView(Context context, int orientation) {
    NoBounceRecyclerView bounceRecyclerView = new NoBounceRecyclerView(context, mLayoutType, mColumnCount, mColumnGap, orientation);
