...
public class NoBounceRecyclerView extends NoBaseBounceView<WXRecyclerView> implements ListComponentView,WXGestureObservable {
  ...
  public NoBounceRecyclerView(Context context, int type, int columnCount, float columnGap, int orientation) {
  ...
  public NoBounceRecyclerView(Context context, int type, int orientation) {
