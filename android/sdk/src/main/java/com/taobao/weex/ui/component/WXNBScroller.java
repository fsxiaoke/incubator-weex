...
import com.taobao.weex.ui.view.refresh.wrapper.NoBounceScrollerView;
...
public class WXNBScroller extends WXVContainer<ViewGroup> implements WXScrollViewListener,Scrollable {
  ...
  public static class Creator implements ComponentCreator {
    ...
    public WXComponent createInstance(WXSDKInstance instance, WXVContainer parent, BasicComponentData basicComponentData) throws IllegalAccessException, InvocationTargetException, InstantiationException {
      ...
      return new WXNBScroller(instance, parent, basicComponentData);
    }
  }
  /**
  ...
  @Deprecated
  public WXNBScroller(WXSDKInstance instance, WXVContainer parent, String instanceId, boolean isLazy, BasicComponentData basicComponentData) {
    this(instance, parent, basicComponentData);
  }

  public WXNBScroller(WXSDKInstance instance, WXVContainer parent, BasicComponentData basicComponentData) {
  ...
  public void setMarginsSupportRTL(ViewGroup.MarginLayoutParams lp, int left, int top, int right, int bottom) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
      ...
      if (lp instanceof LayoutParams) {
        LayoutParams lp_frameLayout = (LayoutParams) lp;
        if (isLayoutRTL()) {
  ...
  protected ViewGroup initComponentHostView(@NonNull Context context) {
    ...
    if(("horizontal").equals(scroll)){
      ...
      final WXNBScroller component = this;
      ...
      NoBounceScrollerView scrollerView = new NoBounceScrollerView(context, mOrientation, this);
      mRealView = new FrameLayout(context);
  ...
  private boolean checkItemVisibleInScroller(WXComponent component) {
    ...
    while (component != null && !(component instanceof WXNBScroller)) {
      if (component.getParent() instanceof WXNBScroller) {
        if (mOrientation == Constants.Orientation.HORIZONTAL) {
